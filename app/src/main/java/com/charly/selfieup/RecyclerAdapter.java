...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        TextDrawable tdHour = TextDrawable.builder().beginConfig().bold().endConfig()
                .buildRoundRect(time[0], Color.parseColor("#3333ff"), 10);;
        TextDrawable tdMinute = TextDrawable.builder().beginConfig().bold().endConfig()
                .buildRoundRect(time[1] + "pm", Color.parseColor("#3333ff"), 10);;
        TextDrawable tdDays = TextDrawable.builder().beginConfig().endConfig()
